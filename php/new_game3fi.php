<?php
	...
	// example: bdgames.nl/geneeskunde/php/new_game3fi.php?studynr=99999&gamepart=1&FI_TIM01=580&FI_TIM02=26&FI_TIM03=372
	// ----------------------------------------
	...
	$query = "INSERT INTO Game3fi (
			...
			SELECT
				...
				'$arg_gamepart' as FI_PART,
				$arg_tim
				$arg_res
				";

	mysqli_query($conn, $query) or die('{"result":"ERROR","message":"error receiving game 3 add new, insert failed ' . mysqli_error($conn) . '"}'); 

	include 'closedb.php';

	// upload successful
	exit('{"result":"OK", "message":"game 3 add new reveived successfully 456"}');
?>