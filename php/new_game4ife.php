<?php
	...
	// example: bdgames.nl/geneeskunde/php/new_game4ife.php?studynr=99999&gamepart=1&IFE_TIM01=580&IFE_TIM02=26&IFE_TIM03=372
	// ----------------------------------------
	...
	$query = "INSERT INTO Game4ife (
			...
			SELECT
				...
				'$arg_gamepart'  as IFE_PART,
				$arg_tim
				$arg_res
				";

	mysqli_query($conn, $query) or die('{"result":"ERROR","message":"error receiving game 4 add new, insert failed ' . mysqli_error($conn) . '"}'); 

	include 'closedb.php';

	// upload successful
	exit('{"result":"OK", "message":"game 4 add new reveived successfully 456"}');
?>