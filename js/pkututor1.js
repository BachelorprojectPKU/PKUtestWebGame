...
var Tutorial1 = new Phaser.Class({
    ...
    create: function ()
    {
		if (globalvar.game_part == 1) {
			...
			var spr1 = this.add.sprite(GAME_WIDTH_CENTER, GAME_HEIGHT-240, "sprites", "game1_plus");
			...
			var spr2 = this.add.sprite(GAME_WIDTH_CENTER-80, GAME_HEIGHT-240, "sprites", "game1_square");
			var txt4 = this.add.bitmapText(60, 120+180, "fontwhite", "Daarna verandert het blokje weer terug in een kruisje. ", 24);
			var spr3 = this.add.sprite(GAME_WIDTH_CENTER+80, GAME_HEIGHT-240, "sprites", "game1_plus");
